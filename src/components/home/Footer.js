        ...
        <footer className="w-full backdrop-blur-sm border-t border-gray-200/50 dark:border-gray-700/50 py-6 mt-auto">
            <div className="container mx-auto px-4">
                ...
                <div className="text-center">
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-full border border-gray-200/60 dark:border-gray-600/60 shadow-sm">
                        ...
                        <span className="text-sm text-gray-600 dark:text-gray-300">
                            仅支持BSC主网，供学习研究，网页可能存在Bug，使用风险自担
                        </span>
                    </div>
                </div>
