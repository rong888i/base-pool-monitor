                                    ...
                                    <>
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            <div className="grid grid-cols-2 gap-3">
                                                <PriceInput label="" value={priceLower} onChange={(e) => setPriceLower(e.target.value)} onAdjust={(dir) => adjustPrice('min', dir)} />
                                                <PriceInput label="" value={priceUpper} onChange={(e) => setPriceUpper(e.target.value)} onAdjust={(dir) => adjustPrice('max', dir)} />
                                            </div>
                                        </div>
